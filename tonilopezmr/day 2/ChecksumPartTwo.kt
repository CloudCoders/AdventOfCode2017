...
class ChecksumPartTwo {
  ...
  @Test
  fun `checksum of the evenly divisible values`() {
    val input = arrayOf(
        arrayOf(5, 9, 2, 8),
        arrayOf(9, 4, 7, 3),
        arrayOf(3, 8, 6, 5)
    ...
    assertEquals(9, evenlyDivisibleChecksum(input))
  }

  @Test
  fun `the checksum of the part two is`() {
    ...
    assertEquals(280, evenlyDivisibleChecksum(day2Parser(input)))
  }
}